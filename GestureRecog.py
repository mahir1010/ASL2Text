...
def skinDetectionHSV(img):
    ...
    skinMaskHSV = cv2.bitwise_or((cv2.inRange(imageHSV, (0, 25, 80), (50, 255, 255))),
                                 (cv2.inRange(imageHSV, (150, 25, 80), (255, 255, 255))))
...
if __name__ == "__main__":
    ...
    while (True):
        ...
        if DEBUG:
            cv2.imshow("skinMatching", skinMatching)
        ...
        if len(contours) != 0:
            ...
            if maxVal > 0.7:
                ...
                tt = cv2.copyMakeBorder(templates_gray[idx], 50, fH - tH - 50, 50, fW - tW - 50, cv2.BORDER_CONSTANT,
                                        value=0)
